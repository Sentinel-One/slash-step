...
class Step(object):
    ...
    def _start(self):
        ...
        hooks.step_start.trigger({"message": self.message})

    def _success(self):
        hooks.step_success.trigger({"message": self.message})

    def _error(self):
        hooks.step_error.trigger({"message": self.message})

    def _end(self):
        hooks.step_end.trigger({"message": self.message})
